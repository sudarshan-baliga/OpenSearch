...
public class TransportNodesGatewayStartedShardHelper {
     ...
     * If the data path passed to the method is not empty then same is returned. Else the custom data path is returned
     ...
     * @return String
     */
    public static String getCustomDataPathForShard(Logger logger, ShardId shardId, String dataPath, Settings settings, ClusterService clusterService) {
     ...
     * @return Exception
     */
    public static Exception getShardCorruption(Logger logger, NodeEnvironment nodeEnv, ShardId shardId, ShardStateMetadata shardStateMetadata, String customDataPath) {
        ...
        try {
            ...
            logger.trace(() -> new ParameterizedMessage("{} can't open index for shard [{}] in path [{}]", shardId, shardStateMetadata, (finalShardPath != null) ? finalShardPath.resolveIndex() : ""), exception);
            return exception;
        }
        return null;
    }
     ...
     * @return String
     */
    public static String NodeGatewayStartedShardsToString(String allocationId, boolean primary, Exception storeException, ReplicationCheckpoint replicationCheckpoint) {
     ...
     * @return int
     */
    public static int NodeGatewayStartedShardsHashCode(String allocationId, boolean primary, Exception storeException, ReplicationCheckpoint replicationCheckpoint) {
     ...
     * @throws IOException
     */
    public static void NodeGatewayStartedShardsWriteTo(StreamOutput out, String allocationId, boolean primary, Exception storeException, ReplicationCheckpoint replicationCheckpoint) throws IOException {
